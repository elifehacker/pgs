...
#include <pname>          // pname number type
...
#include <cpname>         // (since C++11)(deprecated in C++17) 	simply includes the header <pname>
#include <ctgmath>          // (since C++11)(deprecated in C++17) 	simply includes the headers <cpname> (until C++17)<pname> (since C++17) and <cmath>: the overloads equivalent to the contents of the C header tgmath.h are already provided by those headers
